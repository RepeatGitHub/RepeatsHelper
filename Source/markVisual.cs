    ...
    public override void Render() {
        ...
        if (self!=null) {
            if(RepeatsHelperModule.Session.hasMarkOfCommunication&&markAlpha>0) {
                GFX.Game["util/pixel"].Draw(self.Position+new Vector2 (-1,-25), new Vector2 (0,0), new Color(new Vector3 (Convert.ToInt32(255),Convert.ToInt32(255),Convert.ToInt32(255)))*markAlpha*0.5f, new Vector2 (1,1));
            }
